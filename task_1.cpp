...
// читаем следубщую строчку и находим соседей числа из предыдущей строчки, смотрим, кто из них меньше,
// суммируем с прредыдущим и добавляем в path (как шли по пирамиде). на следующих строчках делаем всё то же самое
#include <iostream>
#include <vector>
#include <algorithm>
int main() {
